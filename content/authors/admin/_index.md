...
social:
  - icon: envelope
    icon_pack: fas
    link: 'mailto:hchen27@nd.edu'
  - icon: google-scholar
    icon_pack: ai
    link: https://scholar.google.com/citations?user=u5AHuZYAAAAJ
  - icon: github
    icon_pack: fab
    link: https://github.com/haochen27
  - icon: linkedin
    icon_pack: fab
    link: https://www.linkedin.com/in/hao-chen-26408716a/
  # Link to a PDF of your resume/CV.
  # To use: copy your CV to `static/uploads/resume.pdf` and uncomment the lines below.
  # - icon: cv
  #   icon_pack: ai
